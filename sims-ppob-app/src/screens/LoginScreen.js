    ...
    <>
      <div className=" grid grid-cols-2">
        <div>
          ...
          {showAlert && (
            <div className=" bg-red-100 px-5 flex justify-between mx-10 mt-64 rounded">
              <p className=" text-sm text-red-500 my-1">password yang anda masukan salah </p>
        ...
        <div className="relative h-screen w-auto overflow-hidden">
          <img className="absolute h-full w-full object-cover right-0" src={ilustrasi} alt="ilustartion" />
        </div>
      </div>
    </>
  );
